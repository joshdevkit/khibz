<table class="min-w-full bg-white divide-y divide-gray-200">
    ...
    <tbody class="divide-y divide-gray-200">
        ...
        <tr class="hover:bg-gray-50 transition duration-150">
            ...
            <td class="py-4 px-4 whitespace-nowrap text-sm text-green-700">{{ $reservation->status }}</td>
            <td class="py-4 px-4 whitespace-nowrap text-sm text-gray-800">
                <button type="button" onclick="showModal({{ $reservation->id }})" class="text-gray-600 hover:text-blue-800 transition duration-150 focus:outline-none" title="See Details">
        ...
        @empty
        <tr>
            <td colspan="8" class="py-4 px-4 text-center text-sm text-gray-600">No reservations found in history.</td>
        </tr>
        @endforelse
    </tbody>
</table>
